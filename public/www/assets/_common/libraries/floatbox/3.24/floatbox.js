...
enableDrag:      false     ,// true|false
showCaption:     true     ,// true|false
showPrint:       false     ,// true|false
...
language:       'hu'    ,// 'auto'|'en'|... (see the languages folder)
graphicsType:   'international'    ,// 'auto'|'international'|'english'
urlGraphics:    '/assets/_common/libraries/floatbox/3.24/graphics/'   ,// change this if you install in another folder
urlLanguages:   '/assets/_common/libraries/floatbox/3.24/languages/'  ,// change this if you install in another folder
/*** </General Options> ***/
...
numIndexLinks:      13        ,// number, -1 = no limit
...
resizeDuration:       5    ,// 0-10
imageFadeDuration:    5    ,// 0-10
overlayFadeDuration:  5      ,// 0-10
...
updatePanels: function() {
	...
	if (item.revOptions.showPrint || this.showPrint) {
